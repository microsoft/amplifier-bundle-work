...
Preserve provider neutrality, explicit delegation policy, and immutable module
sources. Keep credentials, user settings, transcripts, and live test output out
